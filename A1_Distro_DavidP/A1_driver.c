 ...
 * tests below.
 */
#include "MDB-c_1006206428.c"  // <--- This will import your code so we can
...
// 
    ...
    insertCastMember("Back to the Future", "Universal Studios", 1985, MDB_head, "Christopher Lloyd Fox");
    insertCastMember("Back to the Future", "Universal Studios", 1985, MDB_head, "Lea fox Thompson");
    insertCastMember("Back to the Future", "Universal Studios", 1985, MDB_head, "Crispin GloverFox");
